...
class Tree:
    ...
    def _helper(self)-> Tuple[int,int]:
        if self.is_empty():
            return 0,0
        elif self._subtrees == []:
            return 0,0
            ...
            for subtree in self._subtrees:
                data = subtree._helper()
                nodes_with_children += data[0]
                children += data[1]
            return nodes_with_children, children
    ...
    def items_at_depth(self, d: int) -> List:
        ...
        Precondition: d q>= 1. (Depth 1 is the root of the tree.)
